...
const QUESTIONS = [
  ...
  { id:"10-1", tier:10, type:`OX퀴즈`,
    ...
    a:`X`,
    verses:[`잠언 28:1  악인은 쫓아오는 자가 없어도 도망하나 의인은 사자 같이 담대하니라`],
    refs:[`해설: 악인은 소심하고, 의인은 용기롭다는 뜻이 아님. 의인은 하나님 앞에 살기 때문에 담대하다는 것을 저자는 이야기 함`],
  ...
  { id:"10-2", tier:10, type:`5지선다`,
    ...
    a:`②`,
    verses:[`잠언 25:3  하늘의 높음과 땅의 깊음 같이 왕의 마음은 헤아릴 수 없느니라`, `이사야 43:18  너희는 이전 일을 기억하지 말며 옛날 일을 생각하지 말라`, `이사야 43:19  보라 내가 새 일을 행하리니 이제 나타낼 것이라 너희가 그것을 알지 못하겠느냐 반드시 내가 광야에 길을 사막에 강을 내리니`],
    refs:[`해설: 두 구절 모두 우리가 인지하지 못해도 살아서 일하고 계시는 하나님에 대해 이야기 하고 있으며, 따라서 우린 그분의 일하심을 의심하지 말 것을 권면한다.`],
  ...
  { id:"10-3", tier:10, type:`4지선다`,
    ...
    a:`④`,
    verses:[`잠언 16:3  너의 행사를 여호와께 맡기라 그리하면 네가 경영하는 것이 이루어지리라`],
    refs:[`해설: "맡기라"의 의미는 '굴리다', '옮기다', '뒹굴다', '던지다' 즉 자기포기, 자기 부인, 전적인 신뢰와 순종인데, 즉 내 손에서 하나님의 손으로 넘겨주는 주권이양.`],
    src:`예은 탭 9번 · 성경퀴즈대회 문항 최종.md` },

  { id:"10-4", tier:10, type:`주관식 그림문제`,
    q:`다음 그림이 나타내는 사람은 어떤 사람인가?`,
    img:[`문항 이미지/10-4.jpg`], imgH:`66vh`, qSize:`clamp(16px,1.8vw,22px)`,
    a:`게으른 자`,
    verses:[`잠언 20:4  게으른 자는 가을에 밭 갈지 아니하나니 그러므로 거둘 때에는 구걸할지라도 얻지 못하리라`, `잠언 19:24  게으른 자는 자기의 손을 그릇에 넣고서도 입으로 올리기를 괴로워하느니라`],
    refs:[],
  ...
  { id:"10-5", tier:10, type:`5지선다`,
    ...
    a:`③`,
    verses:[`잠언 9:1  지혜가 그의 집을 짓고 일곱 기둥을 다듬고`],
    refs:[],
  ...
  { id:"10-6", tier:10, type:`그림 선택형`,
    ...
    a:`②`,
    verses:[`잠언 23:9  미련한 자의 귀에 말하지 말지니 이는 그가 네 지혜로운 말을 업신여길 것임이니라`],
    refs:[],
  ...
  { id:"20-1", tier:20, type:`4지선다`,
    ...
    verses:[`잠언 13:24  매를 아끼는 자는 그의 자식을 미워함이라 자식을 사랑하는 자는 근실히 징계하느니라`],
    refs:[],
    src:`예은 탭 1번 · 성경퀴즈대회 문항 최종.md` },

  { id:"20-2", tier:20, type:`5지선다`,
    q:`잠언에 나오는 '면류관'에 대한 내용 중 아닌 것은?\n\n① 영화의 면류관\n② 생명의 면류관\n③ 지식의 면류관\n④ 노인의 면류관\n⑤ 지아비의 면류관`,
    a:`② 생명의 면류관\n(잠언에는 없고 야고보서 1:12, 요한계시록 2:10 등에 나옴)`,
    verses:[`잠언 16:31  백발은 영화의 면류관이라 공의로운 길에서 얻으리라`, `잠언 17:6  손자는 노인의 면류관이요 아비는 자식의 영화니라`, `잠언 14:18  어리석은 자는 어리석음으로 기업을 삼아도 슬기로운 자는 지식으로 면류관을 삼느니라`, `잠언 12:4  어진 여인은 그 지아비의 면류관이나 욕을 끼치는 여인은 그 지아비의 뼈가 썩음 같게 하느니라`],
    refs:[],
  ...
  { id:"20-3", tier:20, type:`4지선다(그림, 빈칸 채우기)`,
    ...
    a:`① 독수리`,
    verses:[`잠언 23:5  네가 어찌 허무한 것에 주목하겠느냐 정녕히 재물은 스스로 날개를 내어 하늘을 나는 독수리처럼 날아가리라`],
    refs:[],
  ...
  { id:"20-4", tier:20, type:`상황 판단형(4지선다)`,
    ...
    verses:[`잠언 6:30  도둑이 만일 주릴 때에 배를 채우려고 도둑질하면 사람이 그를 멸시하지는 아니하려니와`, `잠언 6:31  들키면 칠 배를 갚아야 하리니 심지어 자기 집에 있는 것을 다 내주게 되리라`],
    refs:[],
  ...
  { id:"20-5", tier:20, type:`4지선다`,
    ...
    a:`②`,
    verses:[`잠언 16:1  마음의 경영은 사람에게 있어도 말의 응답은 여호와께로부터 나오느니라`],
    refs:[`해설: 1절 말씀의 의미는 하나님은 우리에게 내 마음의 경영권을 나에게 위탁하셨다. (자유의지를 주셨다) 위탁하신 하나님의 기대는, 스스로 선택하되, 하나님을 선택하는 쪽으로향하길 원하신다. 그리고 하나님을 선택했다면 기도해야한다. 내 경영권이 바로 위탁될 수 있도록. 인간의 계획이 아무리 완벽할지라도 하나님이 만져주실 때 완성될 수 있다.`],
  ...
  { id:"20-6", tier:20, type:`상황 판단형(그림)`,
    ...
    a:`병`,
    verses:[`잠언 12:16  미련한 자는 당장 분노를 나타내거니와 슬기로운 자는 수욕을 참느니라`, `잠언 12:5  의인의 생각은 정직하여도 악인의 도모는 속임이니라`, `잠언 12:17  진리를 말하는 자는 의를 나타내어도 거짓 증인은 속이는 말을 하느니라`, `잠언 12:19  진실한 입술은 영원히 보존되거니와 거짓 혀는 잠시 동안만 있을 뿐이니라`, `잠언 12:20  악을 꾀하는 자의 마음에는 속임이 있고 화평을 의논하는 자에게는 희락이 있느니라`, `잠언 12:22  거짓 입술은 여호와께 미움을 받아도 진실하게 행하는 자는 그의 기뻐하심을 받느니라`, `잠언 19:5  거짓 증인은 벌을 면하지 못할 것이요 거짓말을 하는 자도 피하지 못하리라`, `출애굽기 20:16  네 이웃에 대하여 거짓 증거하지 말라`, `잠언 12:15  미련한 자는 자기 행위를 바른 줄로 여기나 지혜로운 자는 권고를 듣느니라`],
    refs:[`갑: 12:16`, `을: 성경은 진실을 말할 것을 원칙으로 가르칩니다. (12:5, 17, 19, 20, 22 · 19:5 · 출 20:16)`, `병: 12:15`],
  ...
  { id:"30-1", tier:30, type:`5지선다`,
    ...
    a:`⑤ 의인의 열매는 생명나무라`,
    verses:[`잠언 13:14  지혜 있는 자의 교훈은 생명의 샘이니 사망의 그물에서 벗어나게 하느니라`, `잠언 14:27  여호와를 경외하는 것은 생명의 샘이니 사망의 그물에서 벗어나게 하느니라`, `잠언 10:11  의인의 입은 생명의 샘이라도 악인의 입은 독을 머금었느니라`, `잠언 16:22  명철한 자에게는 그 명철이 생명의 샘이 되거니와 미련한 자에게는 그 미련한 것이 징계가 되느니라`, `잠언 11:30  의인의 열매는 생명 나무라 지혜로운 자는 사람을 얻느니라`],
    refs:[],
  ...
  { id:"30-2", tier:30, type:`4지선다`,
    ...
    a:`① 재물을 많이 소유한 것`,
    verses:[`잠언 15:16  가산이 적어도 여호와를 경외하는 것이 크게 부하고 번뇌하는 것보다 나으니라`],
    refs:[`① 재물을 사랑하는 마음이 해로운 것임. 가산이 적은 게 잘하는 것도 아니고, 재물이 많은 게 죄라는 것도 아님. 그러나 재물은 인생을 번뇌케한다.`,
          `② 분을 쉽게 내는 것  ③ 게으름  ④ 독단적인 사고`],
    src:`예은 탭 5번 · 성경퀴즈대회 문항 최종.md` },

  { id:"30-3", tier:30, type:`주관식(히브리어 단어)`,
    q:`다음 단어를 히브리어로 하면 무엇인가요?\n\n① 잠언\n② 지혜롭다\n③ 맡기다`,
    a:`① 마샬 ② 호크마 ③ 갈랄`,
    refs:[`잠언=마샬, 지혜롭다=호크마, 맡기다=갈랄`],
  ...
  { id:"30-4", tier:30, type:`서술형(3가지 나열)`,
    ...
    a:`하나님을 하나님으로 인정해드린다.\n하나님을 하나님으로 존중한다.\n하나님의 말씀대로 순종한다.`,
    verses:[`잠언 14:27  여호와를 경외하는 것은 생명의 샘이니 사망의 그물에서 벗어나게 하느니라`],
    refs:[],
  ...
  { id:"30-5", tier:30, type:`순서 배열형`,
    ...
    a:`ㄹ-ㄴ-ㄱ-ㄷ (3:5~6)`,
    verses:[`잠언 3:5  너는 마음을 다하여 여호와를 신뢰하고 네 명철을 의지하지 말라`, `잠언 3:6  너는 범사에 그를 인정하라 그리하면 네 길을 지도하시리라`],
    refs:[],
  ...
  { id:"30-6", tier:30, type:`초성 퀴즈`,
    ...
    verses:[`잠언 8:17  나를 사랑하는 자들이 나의 사랑을 입으며 나를 간절히 찾는 자가 나를 만날 것이니라`],
    refs:[],
  ...
  { id:"40-1", tier:40, type:`객관식(정답 2개)`,
    ...
    a:`⑤, ⑧`,
    verses:[`잠언 26:16  게으른 자는 사리에 맞게 대답하는 사람 일곱보다 자기를 지혜롭게 여기느니라`, `잠언 26:27  함정을 파는 자는 그것에 빠질 것이요 돌을 굴리는 자는 도리어 그것에 치이리라`, `잠언 26:28  거짓말하는 혀는 자기가 해한 자를 미워하고 아첨하는 입은 패망을 일으키느니라`],
    refs:[],
  ...
  { id:"40-2", tier:40, type:`연결형(4쌍)`,
    ...
    a:`㉠-ⓑ   ㉡-ⓐ   ㉢-ⓒ   ㉣-ⓓ`,
    verses:[`잠언 13:1  지혜로운 아들은 아비의 훈계를 들으나 거만한 자는 꾸지람을 즐겨 듣지 아니하느니라`, `잠언 13:3  입을 지키는 자는 자기의 생명을 보전하나 입술을 크게 벌리는 자에게는 멸망이 오느니라`, `잠언 14:18  어리석은 자는 어리석음으로 기업을 삼아도 슬기로운 자는 지식으로 면류관을 삼느니라`, `잠언 14:2  정직하게 행하는 자는 여호와를 경외하여도 패역하게 행하는 자는 여호와를 경멸하느니라`],
    refs:[],
    src:`예은 탭 4번 · 성경퀴즈대회 문항 최종.md` },

  { id:"40-3", tier:40, type:`연결형(4쌍)`,
    q:`다음 잠언 30장 구절과 그 동물을 옳게 연결하시오.\n\n① 힘이 없지만 먹을 것을 여름에 준비하는 ⓐ 개미\n② 약하지만 집을 바위에 짓는 ⓑ 사반\n③ 임금이 없지만 다 떼를 지어 다니는 ⓒ 메뚜기\n④ 작아도 왕궁에 있는 ⓓ 도마뱀`,
    a:`①-ⓐ   ②-ⓑ   ③-ⓒ   ④-ⓓ`,
    verses:[`잠언 30:24  땅에 작고도 가장 지혜로운 것 넷이 있나니`, `잠언 30:25  곧 힘이 없는 종류로되 먹을 것을 여름에 준비하는 개미와`, `잠언 30:26  약한 종류로되 집을 바위 사이에 짓는 사반과`, `잠언 30:27  임금이 없으되 다 떼를 지어 나아가는 메뚜기와`, `잠언 30:28  손에 잡힐 만하여도 왕궁에 있는 도마뱀이니라`],
    refs:[],
  ...
  { id:"40-4", tier:40, type:`연결형(4쌍)`,
    ...
    a:`①-ⓒ   ②-ⓐ   ③-ⓓ   ④-ⓑ`,
    verses:[`잠언 19:5  거짓 증인은 벌을 면하지 못할 것이요 거짓말을 하는 자도 피하지 못하리라`, `잠언 19:9  거짓 증인은 벌을 면하지 못할 것이요 거짓말을 뱉는 자는 망할 것이니라`, `잠언 19:11  노하기를 더디 하는 것이 사람의 슬기요 허물을 용서하는 것이 자기의 영광이니라`, `잠언 19:16  계명을 지키는 자는 자기의 영혼을 지키거니와 자기의 행실을 삼가지 아니하는 자는 죽으리라`, `잠언 19:20  너는 권고를 들으며 훈계를 받으라 그리하면 네가 필경은 지혜롭게 되리라`, `잠언 19:26  아비를 구박하고 어미를 쫓아내는 자는 부끄러움을 끼치며 능욕을 부르는 자식이니라`],
    refs:[],
  ...
  { id:"40-5", tier:40, type:`릴레이 단답(4가지, 팀 협동)`,
    ...
    a:`진리, 지혜, 훈계, 명철`,
    verses:[`잠언 23:23  진리를 사되 팔지는 말며 지혜와 훈계와 명철도 그리할지니라`],
    refs:[`해설: 진리·지혜·훈계·명철은 값을 치르고서라도 지켜야 할 것`],
  ...
  { id:"40-6", tier:40, type:`주관식`,
    ...
    a:`계명`,
    verses:[`잠언 7:1  내 아들아 내 말을 지키며 내 계명을 간직하라`, `잠언 7:2  내 계명을 지켜 살며 내 법을 네 눈동자처럼 지키라`, `잠언 7:3  이것을 네 손가락에 매며 이것을 네 마음판에 새기라`, `잠언 7:4  지혜에게 너는 내 누이라 하며 명철에게 너는 내 친족이라 하라`, `잠언 7:5  그리하면 이것이 너를 지켜서 음녀에게, 말로 호리는 이방 여인에게 빠지지 않게 하리라`],
    refs:[],
  ...
  { id:"50-1", tier:50, type:`빈칸 채우기(공통 오답 찾기)`,
    ...
    a:`② 피난처\n(①③④⑤는 모두 "생명")`,
    verses:[`잠언 13:3  입을 지키는 자는 자기의 생명을 보전하나 입술을 크게 벌리는 자에게는 멸망이 오느니라`, `잠언 14:26  여호와를 경외하는 자에게는 견고한 의뢰가 있나니 그 자녀들에게 피난처가 있으리라`, `잠언 15:31  생명의 경계를 듣는 귀는 지혜로운 자 가운데에 있느니라`, `잠언 16:15  왕의 희색은 생명을 뜻하나니 그의 은택이 늦은 비를 내리는 구름과 같으니라`, `잠언 13:14  지혜 있는 자의 교훈은 생명의 샘이니 사망의 그물에서 벗어나게 하느니라`],
    refs:[],
  ...
  { id:"50-2", tier:50, type:`5지선다`,
    ...
    a:`③`,
    verses:[`잠언 14:30  평온한 마음은 육신의 생명이나 시기는 뼈를 썩게 하느니라`, `잠언 26:27  함정을 파는 자는 그것에 빠질 것이요 돌을 굴리는 자는 도리어 그것에 치이리라`],
    refs:[`빌립보서 4:12  나는 비천에 처할 줄도 알고 풍부에 처할 줄도 알아 모든 일 곧 배부름과 배고픔과 풍부와 궁핍에도 처할 줄 아는 일체의 비결을 배웠노라`, `잠언 30:9  혹 내가 배불러서 하나님을 모른다 여호와가 누구냐 할까 하오며 혹 내가 가난하여 도둑질하고 내 하나님의 이름을 욕되게 할까 두려워함이니이다`],
  ...
  { id:"50-3", tier:50, type:`OX(5문항, 팀 협동)`,
    ...
    a:`① O  ② X  ③ O  ④ O  ⑤ X`,
    verses:[`잠언 24:17  네 원수가 넘어질 때에 즐거워하지 말며 그가 엎드러질 때에 마음에 기뻐하지 말라`, `잠언 24:18  여호와께서 이것을 보시고 기뻐하지 아니하사 그의 진노를 그에게서 옮기실까 두려우니라`],
    refs:[`해설: ① O - 다윗은 원수 사울의 전사 소식에 애통해하며 금식함 ② X - 요나는 니느웨가 멸망하기를 바라다 하나님께 책망받음 ③ O - 요셉은 자신을 판 형들을 용서하며 위로함 ④ O - 욥은 모든 것을 잃고 죄인 취급을 받아도 입술로 범죄하지 않음 ⑤ X - 에돔 족속은 형제 나라 유다의 몰락을 기뻐하다 심판을 받음(오바댜)`],
...
제 꾀에 제가 넘어간다`,
    ...
    verses:[`잠언 22:6  마땅히 행할 길을 아이에게 가르치라 그리하면 늙어도 그것을 떠나지 아니하리라`, `잠언 11:2  교만이 오면 욕도 오거니와 겸손한 자에게는 지혜가 있느니라`, `잠언 15:1  유순한 대답은 분노를 쉬게 하여도 과격한 말은 노를 격동하느니라`, `잠언 11:13  두루 다니며 한담하는 자는 남의 비밀을 누설하나 마음이 신실한 자는 그런 것을 숨기느니라`, `잠언 26:27  함정을 파는 자는 그것에 빠질 것이요 돌을 굴리는 자는 도리어 그것에 치이리라`],
    refs:[],
    src:`혁준 탭 · 잠언과 속담 대응 퀴즈(5쌍) · 성경퀴즈대회 문항 최종.md (배점: 최대 50점 배점 가능, 원본 운영 메모)` },

  { id:"50-5", tier:50, type:`협동 문제(5구절 빈칸)`,
    q:`다음은 잠언의 유명한 구절들입니다.\n조에서 한 사람씩 빈칸에 들어갈 답을 말해서 모두 맞히면 성공입니다!\n\nㄱ. 너의 (   )를 여호와께 맡기라 그리하면 네가 (   )하는 것이 이루어지리라(잠16:3)\nㄴ. 모든 지킬 만한 것 중에 더욱 네 (   )을 지키라 (   )이 이에서 남이니라 (잠4:23)\nㄷ. 사람의 행위가 (   )에는 모두 정직하여도 여호와는 마음을 (   )하시느니라 (잠21:2)\nㄹ. (   )하는 것이 지식의 근본이거늘 미련한 자는 지혜와 훈계를 멸시하느니라 (잠1:7)\nㅁ. 너는 (   )에 그를 (   )하라 그리하면 네 길을 지도하시리라 (잠3:6)`,
    a:`ㄱ. 각각 행사와 경영\nㄴ. 마음, 생명의 근원\nㄷ. 자기 보기, 감찰\nㄹ. 여호와를 경외\nㅁ. 범사, 인정`,
    verses:[`잠언 16:3  너의 행사를 여호와께 맡기라 그리하면 네가 경영하는 것이 이루어지리라`, `잠언 4:23  모든 지킬 만한 것 중에 더욱 네 마음을 지키라 생명의 근원이 이에서 남이니라`, `잠언 21:2  사람의 행위가 자기 보기에는 모두 정직하여도 여호와는 마음을 감찰하시느니라`, `잠언 1:7  여호와를 경외하는 것이 지식의 근본이거늘 미련한 자는 지혜와 훈계를 멸시하느니라`],
    refs:[],
    src:`예은 탭 11번 · 성경퀴즈대회 문항 최종.md` },

  { id:"50-6", tier:50, type:`빈칸 채우기`,
    q:`잠언 6장 16~17절에서 여호와께서 미워하시는 것에 해당하는 말을 각 부위에서 하나씩 고르시오`,
    img:[`문항 이미지/50-6.png`], imgH:`66vh`, qSize:`clamp(16px,1.8vw,22px)`,
    a:`교만한 눈, 거짓된 혀, 무죄한 자의 피를 흘리는 손, 악으로 달려가는 발`,
    verses:[`잠언 6:16  여호와께서 미워하시는 것 곧 그의 마음에 싫어하시는 것이 예닐곱 가지이니`, `잠언 6:17  곧 교만한 눈과 거짓된 혀와 무죄한 자의 피를 흘리는 손과`, `잠언 6:18  악한 계교를 꾀하는 마음과 빨리 악으로 달려가는 발과`, `잠언 6:19  거짓을 말하는 망령된 증인과 및 형제 사이를 이간하는 자이니라`],
    refs:[],
  ...
  return `
    <div class="qpage">
      ...
      ${ROLE === "presenter" ? `<div class="presenter-answer">
        ...
        ${q.verses ? `<div class="pa-refs">${q.verses.map(v => `<div>${esc(v)}</div>`).join("")}</div>` : ""}
  ...
  document.getElementById("overlay").innerHTML = `
    <div class="modal-back" id="ansBack">
      <div class="modal answer-modal">
        ...
        ${q.verses ? `<div class="verses">${q.verses.map(v => `<div>${esc(v)}</div>`).join("")}</div>` : ""}
        ${answerOnly ? "" : `<div class="modal-actions"><button class="btn" id="ansClose">닫기</button></div>`}
      </div>
    </div>`;
...
function esc(s){
  return String(s).replace(/[&<>"]/g, c => ({ "&":"&amp;", "<":"&lt;", ">":"&gt;", '"':"&quot;" }[c]))
    .replace(/\([ \t\u3000]+\)/g, m => "(" + "\u00a0".repeat(Math.max(3, m.length - 2)) + ")\u2060");
}
let toastTimer = null;
function toast(msg){
