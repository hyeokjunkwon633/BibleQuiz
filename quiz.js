...
const QUESTIONS = [
  ...
  { id:"10-4", tier:10, type:`주관식 그림문제`,
    ...
    refs:[`해설: 반복적으로 나오는 게으른 자에 대한 설명`],
  ...
  { id:"40-5", tier:40, type:`릴레이 단답(4가지, 팀 협동)`,
    ...
    refs:[`해설: 진리·지혜·훈계·명철을 값을 치르고서라도 지켜야 할 것으로 아는지 확인`],
...
제 꾀에 제가 넘어간다`,
  ...
  { id:"50-5", tier:50, type:`협동 문제(5구절 빈칸)`,
    ...
    a:`ㄱ. 각각 행사와 경영   ㄴ. 마음, 생명의 근원   ㄷ. 자기 보기, 감찰   ㄹ. 여호와를 경외   ㅁ. 범사, 인정`,
    refs:[`잠16:3`, `잠4:23`, `잠21:2`, `잠1:7`, `잠3:6`],
